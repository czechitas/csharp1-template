...
internal class C29_Generics
{
    ...
    private DataStore<string> store = new DataStore<string>();
    ...
    public void UsingTemplatedClass()
    {
    ...
    public void AddOrUpdate<T>(int index, T data) { }
    public void AddOrUpdate<T>(T data1, T data2) { }
    public void AddOrUpdate<T, T1>(T data1, T1 data2) { }
